                        ...
                        if(api_sct === sct){
                            ...
                            if (routes.pathname == "/" && request.method === "GET") {
                                ...
                                if (action === 'read'){
                                    ...
                                    dbc.query("SELECT id FROM product", [] , (error, count) => {
                                        ...
                                        if(error){
                                            ...
                                            if(count_array){
                                                ...
                                                dbc.query("SELECT * FROM product ORDER BY id DESC LIMIT ? OFFSET ?", [limit, offset] , (error, data) => {
                                    ...
                                    if(search){
                                        ...
                                        dbc.query("SELECT * FROM product WHERE name LIKE ? LIMIT 4", [combine_search] , (error, like) => {
